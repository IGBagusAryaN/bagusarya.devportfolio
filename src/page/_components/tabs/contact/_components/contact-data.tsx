export const contactData = [
  ...
  },
  {
    ...
    bg: "bg-red-700 hover:bg-red-800 text-white",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="white"
  ...
  },
  {
    ...
    bg: "bg-white hover:bg-gray-200 text-gray-900 border border-gray-200",
    icon: <img src="/assets/png/spotify.png" alt="Spotify" width={26} height={16} />,
  },
];
